...
summon villager ~ -128 ~ {Tags: ["wp.center", "spawned", "wp.villager", "wp.selector"], Rotation: [0f, 0f], NoAI: 1b, NoGravity: 1b, Invulnerable: 1b, VillagerData: {profession: "minecraft:nitwit"}, Silent: 1b, CustomNameVisible: 1b, ActiveEffects: [{Id: 14b, Amplifier: 1b, Duration: 999999, ShowParticles: 0b}]}
scoreboard players operation rotation wp.bin += $30 wp.settings
...
summon villager ~ -128 ~ {Tags: ["wp.right", "spawned", "wp.villager", "wp.selector"], Rotation: [0f, 0f], NoAI: 1b, NoGravity: 1b, Invulnerable: 1b, VillagerData: {profession: "minecraft:nitwit"}, Silent: 1b, CustomNameVisible: 1b, ActiveEffects: [{Id: 14b, Amplifier: 1b, Duration: 999999, ShowParticles: 0b}]}
scoreboard players operation rotation wp.bin += $30 wp.settings
