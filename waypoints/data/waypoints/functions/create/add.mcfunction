...
data modify storage waypoints:list bin.CustomName merge from storage waypoints:list temp.CustomName
data modify storage waypoints:list bin.Pos merge from storage waypoints:list temp.Pos
